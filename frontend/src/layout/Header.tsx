...
const HeaderLayout: React.FC = ()=>{
    ...
    const handleConfirmGitAction = () => {
        if (!gitAction) return;
        alert(`You are about to ${gitAction} changes.`);
        setGitAction(null);
    };
        ...
        <header className="fixed top-0 z-50 w-full gap-4 h-[60px] bg-white border-b border-gray-200 px-6 shadow-sm
         flex flex-row items-center">
            ...
            <div className="basis-3/4 flex items-center h-full gap-3">
                ...
                >
                    <SelectTrigger className={cn("min-w-[110px] font-semibold text-white", methodColorClass[requestMethod])}>
                ...
                <div className="flex w-full items-center rounded-md border border-input bg-transparent shadow-xs">
                    ...
                    >
                        <SelectTrigger className="w-[240px] rounded-none border-0 border-r border-input shadow-none focus-visible:ring-0">
            ...
            <AlertDialog open={Boolean(gitAction)} onOpenChange={(open) => !open && setGitAction(null)}>
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={handleConfirmGitAction}>
